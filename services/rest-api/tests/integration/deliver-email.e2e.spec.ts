...
const DLQ_URL = sqsConfig.outboundNotificationsDlqUrl;
  ...
  describe('[e2e]', () => {
    ...
    it('routes permanently failed messages to the correct DLQ [slow]', async () => {
      ...
      await expect({
        ...
        (dlqMsg: SendEmailRequest) => dlqMsg.message.Subject.Data === subject,
      );
    });
  });
});
